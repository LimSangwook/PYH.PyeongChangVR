...
nhn.husky.SE2M_AttachQuickPhoto = jindo.$Class({		
	...
	$ON_ATTACHPHOTO_OPEN_WINDOW : function(){			
		...
		this.htPopupOption.sUrl += '?imageArea='+this.oApp.elPlaceHolder.id+'&isEditor=Y';
		this.htPopupOption.sProperties = "left=0,top=0,width=385,height=450,scrollbars=yes,location=no,status=0,resizable=no";
		//console.log(this.oApp.elPlaceHolder.id);
	...
	makePopupURL : function(){
		var sPopupUrl = "/attachPhotoPop.do";
