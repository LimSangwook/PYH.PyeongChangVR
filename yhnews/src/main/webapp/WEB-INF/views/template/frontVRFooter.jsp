	...
	<div class="wrap-footer footer-type01">
		<footer id="footer" class="footer">
			<button class="btn-scroll-top"><span>SCROLL</span><i></i></button>
				...
				<div>
					<ul class="list01">
						<li class="nav-vr"><a href="/assets/vrFront/html/stadium.html">평창 VR360</a></li>
						<li class="nav-popular"><a href="/assets/vrFront/html/contents_popular.html">인기 VR 컨텐츠</a></li>
						<li class="nav-latest"><a href="/assets/vrFront/html/contents_latest.html">실시간 VR 컨텐츠</a></li>
					</ul>
				</div>
				<div>
					<ul class="list01">
