<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
		<!-- ========================== 내용 시작 ========================= -->
			...
			<div class="search_wrap search_type01">
				<form action="#">
					<fieldset>
						<legend>VR검색</legend>
						<select name="select_std" id="select_std" title="경기장선택" class="inp_type01 col16">
						...
						<select name="select_std" id="select_std" title="구분선택" class="inp_type01 col16">
							<option value="1">제목</option>
							<option value="2">내용</option>
						</select>
						<input type="text" name="" id="" title="" class="inp_type01 col33">
			...
			<div class="vr_list vrlist_type01">
				...
				<div class="item">
					<div class="item_wrap">
						...
						<div class="author">
							...
							<p class="author_good">
								<span class="state">심사중</span>
								<!--<span class="state appro">승인</span>
								<span class="state return">반려</span>-->
							</p>
						</div>
						<div class="btn_wrap">
				...
				<div class="item">
					<div class="item_wrap">
						...
						<div class="author">
							<p class="author_writer"><span class="name">홍길동</span><span class="date">2017-10-24</span></p>
							<p class="author_good"><span class="state appro">승인</span></p>
						</div>
						<div class="btn_wrap">
							<a href="contents_view.html"><span class="ico ico_view"></span><br>상세보기</a>
							<a href="#"><span class="ico ico_vr"></span><br>VR보기</a>
				...
				<div class="item">
					<div class="item_wrap">
						...
						<div class="author">
							<p class="author_writer"><span class="name">홍길동</span><span class="date">2017-10-24</span></p>
							<p class="author_good"><span class="state return">반려</span></p>
						</div>
						<div class="btn_wrap">
							<a href="contents_view.html"><span class="ico ico_view"></span><br>상세보기</a>
							<a href="#"><span class="ico ico_vr"></span><br>VR보기</a>
				...
				<div class="item">
					<div class="item_wrap">
						...
						<div class="author">
							<p class="author_writer"><span class="name">홍길동</span><span class="date">2017-10-24</span></p>
							<p class="author_good"><span class="state">심사중</span></p>
						</div>
						<div class="btn_wrap">
							<a href="contents_view.html"><span class="ico ico_view"></span><br>상세보기</a>
							<a href="#"><span class="ico ico_vr"></span><br>VR보기</a>
