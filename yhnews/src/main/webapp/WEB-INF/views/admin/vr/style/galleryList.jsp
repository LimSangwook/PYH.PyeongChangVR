...
<%@ include file="/WEB-INF/views/comm/taglib.jsp"%>
				...
				<tbody>
					<c:forEach var="data" items="${result}" varStatus="i">
						<tr>
							...
							<td class="textAlign_left"><a href="galleryForm.do?vr_style_gallery_id=${data.vr_style_gallery_id}">${data.title}</a></td>
							<td>5</td>
			...
			<div class="btn_wrap float_right">
				<a href="galleryForm.do" class="btn primary">등록</a>
			</div>
